...
public class CoursePieController extends JPanel implements ObserverPie, ChangeListener, ActionListener {
	/**
	 * Constructs a CourseController object
	 * 
	 * @param courses a set of courses and their marks
	 */
	public CoursePieController(CoursePieData courses) {
	...
	public void update(ObservablePie o) {
		CoursePieData courses = (CoursePieData) o;
	...
	public static void main(String[] args) {
		CoursePieData data = new CoursePieData();
		...
		CoursePieController controller = new CoursePieController(data);
		PieChartObserver pie = new PieChartObserver(data);

		JScrollPane scrollPanePie = new JScrollPane(pie, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	private CoursePieData courseData;
